(function() {
   ...
   person.sayHello = function () {
    ...
    var books = [
        ...
        {
            title: "America Football Team DallasCowboys",
            author: {
                firstName: "Jerry.",
                lastName: "Jones"
            }
    ...
    var books = [
        createBook("The Greatest Laker", "Kobe Bryant"),
        createBook("America Team DallasCowboys", "Jerry Jones"),
        createBook("The Number 9", "Tony Romo"),
        createBook("Javascript For Dummies","David Smith"),
        createBook("HTML & CSS For Dummies","Leonard Miller")
    ];
